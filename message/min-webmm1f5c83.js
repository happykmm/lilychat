...
(function() {
  ...
  function f(b, h) {
    var e, g, o, q, r = d, t, s = h[b];
    s && ("object" === typeof s && "function" === typeof s.toJSON) && (s = s.toJSON(b));
    "function" === typeof i && (s = i.call(h, b, s));
    switch(typeof s) {
      case "string":
        return c(s);
      case "number":
      ...
      case "object":
        ...
        if(i && "object" === typeof i) {
          q = i.length;
          for(e = 0;e < q;e += 1) {
            "string" === typeof i[e] && (g = i[e], (o = f(g, s)) && t.push(c(g) + (d ? ": " : ":") + o))
          }
        }else {
          for(g in s) {
            Object.prototype.hasOwnProperty.call(s, g) && (o = f(g, s)) && t.push(c(g) + (d ? ": " : ":") + o)
          }
        }
        o = 0 === t.length ? "{}" : d ? "{\n" + d + t.join(",\n" + d) + "\n" + r + "}" : "{" + t.join(",") + "}";
        d = r;
...
(function(b, c) {
  ...
  function e(a, c, d, i, e) {
    ...
    b.browser.mozilla && "11.0" == b.browser.version && (a = a.replace(/^http:\/\//, "https://"));
    g.open("POST", a, !0);
...
(function(b, c) {
  ...
  k.prototype = {option:function(a, b) {
    ...
    function a(m) {
      ...
      var n = d._moOrgPos, D = n._nMouseY, n = Math.abs(n._nMouseX - m.clientX), D = Math.abs(D - m.clientY);
      if(d._mnState == e) {
        if(n > h.distance || D > h.distance) {
...
(function(b, c) {
  ...
  g.prototype = {setTriggers:function(c) {
    ...
    if(o.maxContainer) {
      var q = f && this._moPos[3] + b < this._moContainerPos[3], r = j && this._moPos[2] + a > this._moContainerPos[2], t = n && this._moPos[1] + b > this._moContainerPos[1];
...
(function(b, c, f) {
  function g(a) {
    ...
    var b = m[0], c = b.getAttribute("step");
    null == c && (c = 0);
    ...
    if(document.all) {
      ...
      j = document.getElementById("canvas_pop_img");
      null == j && (j = document.createElement("canvas"), j.setAttribute("id", "canvas_pop_img"), b.parentNode.appendChild(j));
      a = j.getContext("2d");
      ...
      switch(c) {
        ...
        ;
        case 0:
          j.setAttribute("width", b.width);
          j.setAttribute("height", b.height);
          a.rotate(0 * Math.PI / 180);
          a.drawImage(b, 0, 0);
          break;
        case 1:
          j.setAttribute("width", b.height);
          j.setAttribute("height", b.width);
        ...
        case 2:
          ...
          break;
        case 3:
          j.setAttribute("width", b.height), j.setAttribute("height", b.width), a.rotate(270 * Math.PI / 180), a.drawImage(b, -b.width, 0)
      }
      j.style.display = "block"
    }
  }
  function e(a, c) {
    var d = a.offset(), e = a.width(), g = a.height(), m = b(f).width(), o = b(f).height(), q = m / 1.5, y = o / 1.5, v = c[0].width, u = c[0].height, E = 2 * v, F = 2 * u, B = v / u, G = m / o;
    if(v > q || u > y) {
      B >= G ? (v = q, u = v / B) : (u = y, v = B * u)
    }
    var C = v / 2, I = u / 2, A = {left:(m - v) / 2, top:(o - u) / 2, width:v, height:u};
    c.width(e).height(g);
    j && (j.style.display = "none");
    c.css("width", "100%").css("height", "100%").css("left", "0");
    var w = c.parent();
    w.css({left:d.left, top:d.top, width:e, height:g}).show().animate(A, 500, "swing", function() {
      h.open().find('[opt="download"]').attr("url", k + "&fun=download");
      i == null && (i = w.find(".iconClose"));
      ...
      n = function(b, c) {
        ...
        debug(C);
        debug(I);
        if(!(b > 0 && (w.width() > E || w.height() > F))) {
          if(!(b < 0 && (w.width() < C || w.height() < I))) {
            a = a + 0.2 * b;
            a < 0.5 && (a = 0.5);
            var d = A.width, e = A.height;
            A.width = v * a;
            A.height = u * a;
            A.left = parseInt(w.css("left")) - (A.width - d) * (c.offsetX / d || 0.5);
            A.top = parseInt(w.css("top")) - (A.height - e) * (c.offsetY / e || 0.5);
            w.css(A)
          }
        }
      };
  ...
  var a = b("#slidePic"), h = b("#popImgOperator"), i = null, k, m, j, n, o;
  h.off("click").on("click", function(a) {
    var a = a.target, b = a.getAttribute("opt");
    if("zoomOut" == b) {
      n(2, {offsetX:0, offsetY:0})
    }else {
      if("zoomIn" == b) {
        n(-2, {offsetX:0, offsetY:0})
      }else {
  ...
  h.appear = function() {
    h.on && (o && clearTimeout(o), h.stop(!0, !0).animate({opacity:1}))
  };
  h.disappear = function() {
    h.on && (o && clearTimeout(o), o = setTimeout(function() {
      h.stop(!0, !0).animate({opacity:0})
    }, 1E3))
  };
  a.delegate("img", "mouseenter", h.appear).delegate("img", "mouseleave", h.disappear);
  c.popImage = function(c, g) {
    ...
    f.onload = function() {
      ...
      a.draggable({handle:"img"})
    };
    f.onerror = function() {
      c.removeWaitEffect()
    };
    c.insertWaitEffect();
    f.src = /^blob:/.test(g) ? k = g : k = g + "&__r=" + d(g)
  };
  var q = {};
  c.widget = b.extend(c.widget || {}, {preLoadImg:function(a, c) {
    if(a && !q[a + "&__r=" + d(a)]) {
      ...
      e.onload = e.onerror = e.onabort = function() {
        q[this.src] && q[this.src].callback && b.safe(q[this.src].callback);
        delete q[this.src]
      };
      e.src = a + "&__r=" + d(a);
      q[e.src] = {img:e, callback:c}
    }
    ...
    d.bind("click keyup keydown change", function(a) {
      ...
      a:for(;f < i;f++) {
        ...
        if(!h.globalIntercept || b.contains(h.interceptDom$[0], j[0])) {
          for(var m = j.parents("[ctrl]"), o = j.attr(a.type), n = o && o.split("@"), r = n && n[0], n = n && n[1], B = 0, G = m.length;o && B < G;B++) {
            var C = m[B].ctrl;
            if(C[r] && (C = C[r](a, j, n && j.parents(n).first()), d = !0, !1 === C)) {
              break a
            }
          }
...
(function(b, c) {
  ...
  c.model("contact", {addContacts:function(b, e) {
    ...
    if(g && !c.util.isShieldUser(g.UserName)) {
      ...
      _oContacts[g.UserName] ? (c.util.isRoomContact(g.UserName) && 0 == g.MemberCount && (delete g.MemberCount, delete g.MemberList), b.extend(_oContacts[g.UserName], g), e = "contactUpdated") : (_oContacts[g.UserName] = g, e = "contactAdded");
...
(function(b, c, f, g) {
  ...
  function h(a) {
    j || (j = c.model("account").getUserName());
    a.isSend = a.FromUserName == j || "" == a.FromUserName;
    return a.isSend ? a.ToUserName : a.FromUserName
  }
  function i(a, c) {
    if(c && !(0 > c.MsgType)) {
  ...
  function k(a) {
    if(a.HasProductId) {
      if(a.MsgType = 1, a.FromUserName == c.model("account").getUserName()) {
  ...
  var m = {}, j = null, n = {isSysMessage:function() {
  ...
  c.addEventListener("accountUpdated", function(a) {
    ...
    if(a = a.avatar) {
      for(var d in m) {
        for(var e = m[d], g = 0, f = e.length;g < f;++g) {
  ...
  c.model("message", {getMessages:function(a) {
    ...
    if(a && !c.util.isShieldUser(a)) {
      ...
      m[a] = [];
      var d = c.util.isFileHelper(a) && 0 == m[a].length ? 1E4 : -9999, e = 0 < d ? c.getRes("text_file_helper_tip") : "", b = 0 < d ? c.util.getServerTime() / 1E3 : b;
    ...
    return a
  }, yMessages:[], addMessages:function(f, j) {
    var r = [], t = this.yMessages;
    b(f).each(function(a, b) {
      for(var c = !1, d = 0;d < t.length;d++) {
        t[d].MsgId == b.MsgId && (c = !0)
      }
      c || r.push(b)
    });
    this.yMessages = f;
    if(f = r) {
      b.isArray(f) || (f = [f]);
      for(var s = 0, z = f.length;s < z;s++) {
        try {
          var p = f[s], x = p.FromUserName, D = p.ToUserName, H = h(p), y = m[H] || (m[H] = []);
          Log.d("msgid=" + p.MsgId);
          k(p);
          p.actualSender = c.util.isRoomContact(x) ? c.util.getRoomMsgActualSender(p) : x;
          if(!(p.MsgType == c.Constants.MM_DATA_STATUSNOTIFY || c.util.isTalkContact(x) || c.util.isTalkContact(D) || c.util.isShieldUser(x) || c.util.isShieldUser(D) || p.MsgType == c.Constants.MM_DATA_VERIFYMSG && p.RecommendInfo && p.RecommendInfo.UserName == c.model("account").getUserInfo().UserName)) {
            var v;
            v = e(y, p.MsgId);
            if(0 > v) {
              var u = a(p);
              ...
              p.FromUserName != c.model("account").getUserName() && (p.unread == g && p.MsgType != c.Constants.MM_DATA_SYS) && (p.unread = !0);
              if(p.MsgType == c.Constants.MM_DATA_VERIFYMSG) {
                var E = d(y, p.RecommendInfo.UserName);
                if(0 > E) {
                  p.History = ["0" + p.RecommendInfo.Content]
                }else {
                  var F = y[E];
                  F.History.push("0" + p.RecommendInfo.Content);
                  p.History = F.History
                }
              }
              ...
              j === g ? (i(y[y.length - 1], p), y.push(p)) : y.splice(j, 0, p);
              b.extend(p, n);
              c.triggerEvent(j === g ? "messageAdded" : "messagePrepend", p)
            }else {
              this.updateMessage(y, v, p)
            }
          }
        }catch(B) {
          Log.e("JS Function: addMessages. try catch error: " + B)
        }
      }
    }
    ...
    m[a] && (delete m[a], c.triggerEvent("sessionDeleted", a))
  }})
})(jQuery, WebMM, this);
(function(b, c, f, g) {
  var e = {};
  ...
  c.logic("sync", {sync:function() {
    ...
    if(d.isStatusValid()) {
      ...
      setTimeout(function() {
        ...
        for(var h = c.model("account"), j = h.getSid(), n = h.getUin(), h = h.getSyncKey().List, o = [], q = 0, r = h.length;q < r;q++) {
          o.push(h[q].Key + "_" + h[q].Val)
        }
        d.startMonitor();
        var t;
        try {
          t = c.getRes("url_push") + "/cgi-bin/mmwebwx-bin/synccheck?skey=" + encodeURIComponent(WebMM.model("account").getSkey())
        }catch(s) {
          t = c.getRes("url_push") + "/cgi-bin/mmwebwx-bin/synccheck"
        }
        b.ajax({url:t, dataType:"jsonp", data:{r:b.now(), sid:j, uin:n, deviceid:c.getDeviceId(), synckey:o.join("|")}, timeout:35E3, complete:function(a, b) {
...
(function(b, c) {
  ...
  c.logic("getconversation", {get:function(a) {
    ...
    var b = d.getContact(a), f = e.getLastMessage(a), k = b && b.DisplayName || f.actualSender || "", m = "", j = !1, n = "", o = "", q = e.getUnreadMsgsCount(a), r = b ? b.initOrder : 0;
    ...
    return{avatar:m, userName:a, name:k, time:n, unread:q, invisible:!1, type:f.MsgType, status:f.Status, digest:o, isRoom:j, memCount:j && b && b.MemberCount, initOrder:r, msgCreateTime:f.CreateTime, weight:g && b && b.weight || f.weight, muted:b && b.isMuted() || !1, contact:b}
  }})
})(jQuery, WebMM, this);
(function(b, c) {
  var f = !1;
...
(function(b, c) {
  c.logic("modChatroom", {addMember:function(b, c, e) {
    ...
    b.netQueue("modChatroom").send("/cgi-bin/mmwebwx-bin/webwxupdatechatroom?fun=" + f, e, {onsuccess:function(a) {
      if("delmember" == f) {
        for(var b = c.model("contact").getContact(g), e = b.MemberList.length - 1;0 <= e;e--) {
          b.MemberList[e].UserName == d && b.MemberList.splice(e, 1)
        }
        b.MemberCount = b.MemberList.length;
        c.model("contact").addContact(b)
      }
      h && h.onsuccess && h.onsuccess(a)
    }, onerror:function() {
    }})
  }, quit:function(f) {
    ...
    if(b) {
      ...
      if(b == e.getUserName()) {
        ...
        if(c.util.isRoomContact(b)) {
          ...
          if((k = g.getContact(b)) && k.HeadImgUrl && 0 < k.HeadImgUrl.length) {
            i = k.HeadImgUrl
          }else {
            k = "";
            c.util.isRoomContact(f) && (k += "&chatroomid=" + f.split("@")[0]);
            try {
              i = "/cgi-bin/mmwebwx-bin/webwxgeticon?username=" + b + k + "&skey=" + encodeURIComponent(WebMM.model("account").getSkey())
            }catch(j) {
              i = "/cgi-bin/mmwebwx-bin/webwxgeticon?username=" + b + k
            }
          }
        }
      }
...
(function(b, c, f) {
  ...
  c.createCtrl("chat", {init:function() {
    ...
    function a() {
      return d.isRoomContact() && !(0 < b.grep(d.MemberList, function(b) {
        return b.UserName == f
      }).length) ? !0 : !1
    }
...
(function(b, c, f, g) {
  ...
  var h = "", i = "", k = !1, m = null, j = c.model("message"), n = [], o = !1, q = b("#vernierContainer .activeChatVernier"), r = null, t = 0, s = !1, z = 0, p = !1, x = null;
  c.createCtrl("chat_conversationListContent", {init:function() {
    ...
    for(var a = z = 0, d = n.length;a < d;a++) {
      var g = n[a];
      z += g.muted ? 0 : g.unread || 0
    }
    p && z ? r.html(z).show() : r.hide();
    if(!e) {
      if(0 < z) {
        b.flashTitle(b.tmpl(c.getRes("text_new_message_come"), {count:z}));
        ...
        if(h && c.model("account").isNotifyOpen()) {
          ...
          MMNotification.notify(h.avatar, b.tmpl(c.getRes("text_new_message_come"), {count:z}), b.subAsiiStr(b.clearHtmlStr(h.name + ": " + a), 50, "..."), {onclick:function() {
            f.focus();
    ...
    f == i && !s && e && d && j.markMsgsRead(i) && (k = !0);
...
(function(b, c, f) {
  ...
  c.model("account");
  var d = 0, a = 0, h = 0, i = b.browser.msie && 9 > b.browser.version ? 300 : 0, k = 0, m = null, j = 0, n = 0, o = !1, q = !1, r = null;
  c.createCtrl("chat_chatmsglist", {init:function() {
    var a = this;
    a.getDom$().scrollable({onscroll:function(b) {
      0 != b || (o || q) || a._msgDelayLoad()
    }})
  }, active:function(a) {
    if(a.userName) {
      if(g == a.userName) {
    ...
    d.html() ? c.length && (g.length || (d.prepend(b.tmpl("chatListloadingMoreMsg", "")), g = b("#chatListloadingMoreMsg")), g.fadeIn("fast"), r = setTimeout(a, 1E3)) : a()
  }, messageAdded:function(a) {
...
(function(b, c, f, g) {
  ...
  a.show();
  !m && h.show();
  var j = {}, n = b.browser.msie ? 300 : 0, o = 0, q = 0, r = 0, t = 0, s = null;
  c.createCtrl("chat_editor", {init:function() {
    var a = this;
    s = a.getDom$().find("textarea");
    b.textAreaResize(s[0], s.height(), 4 * s.height(), function(b) {
      a.getDom$().prev().height(function(a, c) {
        return c - b
      });
      a.getDom$().height(a.getDom$().height() + b)
    });
    s.on("paste", function(d) {
    ...
    o = setTimeout(function() {
      ...
      d != g && (s.val(c.model("history").inputRecord(d)), clearTimeout(q), q = setTimeout(function() {
        b.safe(function() {
          e(d) && s[0].focus()
        })
      }, 300))
    ...
    c.logic("sendMsg").sendAudio(a, t, b)
...
(function(b, c) {
  ...
  c.createCtrl("chat_contactListContent", {init:function() {
    ...
    if(!a || e) {
      var h = c.model("contact").getAllFriendContact(g, !g, {}, !g), n = !g && c.model("contact").getAllStarContact() || [], o = c.model("contact").getAllFriendChatroomContact(g) || [], q = !g && c.model("contact").getAllBrandContact() || [], r = this, t = b.tmpl("contactlist", {init:d, curUserName:f, isSearch:!!g, contacts:h, starContacts:n, roomContacts:o, brandContacts:q, invisible:i});
      i = !1;
      setTimeout(function() {
        r.getDom$().find("#contactListContainer").html(t);
        r._contactImgLoad()
      });
      d || (a = !0)
    }
